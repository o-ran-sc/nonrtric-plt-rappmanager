...
SME
---
Service Manager is a Go implementation of a service that calls the CAPIF Core function. When publishing a service it create a Kong route and Kong service.
