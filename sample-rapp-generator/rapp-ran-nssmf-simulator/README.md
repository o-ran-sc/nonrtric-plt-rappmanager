...
- **Image Repository**: `localhost:5001/ran-nssmf-simulator-rapp`
- **Image Tag**: `1.0.0`
...
docker build -t localhost:5001/ran-nssmf-simulator-rapp:1.0.0 .

# Push to your container registry
docker push localhost:5001/ran-nssmf-simulator-rapp:1.0.0
```
