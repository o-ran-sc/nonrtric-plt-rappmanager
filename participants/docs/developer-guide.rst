...
Additional developer guides are available on the `O-RAN SC NONRTRIC Developer wiki <_nonrtricwikidevguide>`_.
...
For more information on installation of Non-RT RIC and SMO components in Kubernetes, see `Deploy NONRTRIC in Kubernetes <_nonrtricwikik8s>`_.
